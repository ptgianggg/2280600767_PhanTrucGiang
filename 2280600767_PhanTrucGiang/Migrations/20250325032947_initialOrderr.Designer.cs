...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("_2280600767_PhanTrucGiang.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("_2280600767_PhanTrucGiang.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("_2280600767_PhanTrucGiang.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("_2280600767_PhanTrucGiang.Models.Order", b =>
                {
                    b.HasOne("_2280600767_PhanTrucGiang.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("_2280600767_PhanTrucGiang.Models.OrderDetail", b =>
                {
                    b.HasOne("_2280600767_PhanTrucGiang.Models.ApplicationUser", null)
                        .WithMany("OrderDetails")
                        .HasForeignKey("ApplicationUserId");

                    b.HasOne("_2280600767_PhanTrucGiang.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("_2280600767_PhanTrucGiang.Models.MonAn", "MonAn")
                        .WithMany()
